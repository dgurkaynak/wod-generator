...
tf.app.flags.DEFINE_integer('rnn_size', 512, 'The size of RNN hidden state')
tf.app.flags.DEFINE_integer('num_layers', 3, 'The number of layers in the RNN')
tf.app.flags.DEFINE_string('model', 'lstm', 'RNN model: rnn, gru, lstm, or nas')
tf.app.flags.DEFINE_integer('batch_size', 50, 'Batch size')
tf.app.flags.DEFINE_integer('seq_length', 75, 'RNN sequence length')
tf.app.flags.DEFINE_integer('num_epochs', 150, 'Number of epochs for training')
...
tf.app.flags.DEFINE_float('input_dropout_keep_prob', 0.5, 'Input dropout keep probability')
tf.app.flags.DEFINE_float('output_dropout_keep_prob', 0.5, 'Output dropout keep probability')
